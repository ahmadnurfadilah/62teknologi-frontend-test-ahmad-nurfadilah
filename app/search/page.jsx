...
export default function Page() {
  ...
  const getBusinesses = (page) => {
    setLoading(true);
    fetch(
      `/api/search?location=${searchParams.get("location")}&term=${searchParams.get("search") || ""}&sortby=${
  ...
  return (
    <div>
      ...
      <div className="min-h-[92vh] w-1/2 mt-16 pt-4 px-4 md:px-8 pb-16 relative">
